...
//graphs the second harmonic of triangle_waveform
...
void plot_triangle(int xsize, int ysize, float xl, float xu, float dx) {
	...
	while (x < xu ) {
		y1 = triangle_waveform(1.0/5, 3*.6 , x) + triangle_waveform(2.0/5, 3*.2, x) + triangle_waveform(4.0/5, 3*.2, x) + triangle_waveform(8.0/5, 3*.2, x) ;
		x+= dx ;
		y2 = triangle_waveform(1.0/5, 3*.6, x) + triangle_waveform(2.0/5, 3*.2, x) + triangle_waveform(4.0/5, 3*.2, x) _+ triangle_waveform(8.0/5, 3*.2, x);
